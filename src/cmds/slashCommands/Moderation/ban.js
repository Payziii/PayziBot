...
module.exports = {
	...
	async execute(interaction) {
		...
		if (bot.permissions.has('BanMembers') == false) return interaction.reply(`${emojis.error} | Для блокировки пользователя мне необходимо иметь право \`Блокировать участников\`!`);
		let msg;
