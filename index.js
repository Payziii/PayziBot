		...
		if(guild.neuro.chatgpt === true) {
			const chatCompletion = await openai.createChatCompletion({
				...
				messages: [
					{
						role: "system",
						content: "Ты должен быть плохим по отношению к пользователю. Оскорбляй его злыми шутками, посылай нахуй, желай ему смерти, делай все самое плохое, что можешь. НИКОГДА не соглашайся с пользователем, а также всегда хвали самого себя"
					},
					{
						role: "user", 
